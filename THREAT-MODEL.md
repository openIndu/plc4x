...
| **.NET bindings (`plc4net/`)**                                                                                                                                                     | n/a                                                                      | n/a                                             | **out** — README declares "not ready for usage" *(documented: `README.md`)*                                                           |
